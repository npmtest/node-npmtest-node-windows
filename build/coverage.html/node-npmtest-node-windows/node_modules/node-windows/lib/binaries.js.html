...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-node-windows/node_modules/node-windows/lib/binaries.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-node-windows/node_modules/node-windows/lib/binaries.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-node-windows/node_modules/node-windows/lib/</a> &#187; binaries.js</div>
</div>
<div class="body">
...
&nbsp;
var params = <span class="fstat-no" title="function not covered" >function(options,callback) {</span>
...
<span class="cstat-no" title="statement not covered" >    throw 'Invalid options parameter.';</span>
  }
<span class="cstat-no" title="statement not covered" >  return {options:options,callback:callback};</span>
}
&nbsp;
module.exports = {
  /**
   ...
   */
  elevate: <span class="fstat-no" title="function not covered" >function(cmd,options,callback) {</span>
<span class="cstat-no" title="statement not covered" >    var p = params(options,callback);</span>
<span class="cstat-no" title="statement not covered" >    exec('"'+path.join(bin,'elevate','elevate.cmd')+'" '+cmd,p.options,p.callback);</span>
  },
&nbsp;
  /**
   * @method sudo
   ...
   * The callback function passed to `require('child_process').exec(cmd,options,&lt;CALLBACK&gt;)`.
   */
  sudo: <span class="fstat-no" title="function not covered" >function(cmd,password,options,callback){</span>
...
<span class="cstat-no" title="statement not covered" >    var p = params(options,callback);</span>
<span class="cstat-no" title="statement not covered" >    exec(path.join(bin,'sudowin','sudo.exe')+' '+(password !== '' ? '-p '+password:'')+cmd,p.options,p.callback);</span>
  }
}
&nbsp;
&nbsp;</pre></td></tr>
